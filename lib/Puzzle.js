class Puzzle {
  ...
  solvePuzzle() {
    // display input field for guesss
    // take inputs val 
    // compare val to game.currentPuzzle.correct_answer 
    // if correct take score and put into total score for that player
    // reset other all players round score to 0 
    // display correct answer
    // if not correct then go on to next player
  }
